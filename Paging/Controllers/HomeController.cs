...
namespace Paging.Controllers
{
    public class HomeController : Controller
    {
        ...
        private List<ListModel> GetList(int index, out int totalCount)
        {
            ...
            {
                new ListModel {CreateDate = DateTime.Now, Name = "Murat", City = "Sinop", Vote = 1},
                new ListModel {CreateDate = DateTime.Now, Name = "Sevcan", City = "Manisa", Vote = 2},
                new ListModel {CreateDate = DateTime.Now, Name = "Mümin", City = "Samsun", Vote = 4},
                new ListModel {CreateDate = DateTime.Now, Name = "Mustafa", City = "İstanbul", Vote = 7},
                new ListModel {CreateDate = DateTime.Now, Name = "Talha", City = "Ankara", Vote = 18},
                new ListModel {CreateDate = DateTime.Now, Name = "Murat", City = "Sinop", Vote = 1},
                new ListModel {CreateDate = DateTime.Now, Name = "Sevcan", City = "Manisa", Vote = 2},
                new ListModel {CreateDate = DateTime.Now, Name = "Mümin", City = "Samsun", Vote = 4},
                new ListModel {CreateDate = DateTime.Now, Name = "Mustafa", City = "İstanbul", Vote = 7},
